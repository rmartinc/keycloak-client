...
public abstract class AbstractResourceServerTest extends AbstractAuthzTest {
    ...
    public void deleteRealms() {
        // this test in keycloak used isImportAfterEachMethod to true
    ...
    protected AuthorizationResponse authorizeDecision(String accessToken, Boolean matchingUri, PermissionRequest... permissions) {
        ...
        for (PermissionRequest permission : permissions)
            authorizationRequest.addPermission(permission.getResourceId(), new ArrayList<>(permission.getScopes()));
    ...
    protected AuthzClient getAuthzClient() {
        return getAuthzClient("/authorization-test/default-keycloak-uma2.json");
    }
